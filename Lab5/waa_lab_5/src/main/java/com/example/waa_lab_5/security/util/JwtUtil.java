package com.example.waa_lab_5.security.util;
...
public class JwtUtil {
    private final String secret = "ILoveThePhilippines";
...
//                userDetailsService.loadUserByUsername(claims.getSubject()); // LEFT THIS HERE ON PURPOSE
